...
let guestList = ['Rehman', 'taqdees', 'ahad', 'wasay', 'owais', 'Nafay']
...
while (guestList.length>2)
    {let notInvited = guestList.pop()
        console.log(`${notInvited} Sorry You are not invited for the dinner`)
    }

guestList.map((item)=>console.log(`Dear ${item} You are still invited for the dinner`))
guestList.pop()
guestList.pop()
console.log(guestList)
