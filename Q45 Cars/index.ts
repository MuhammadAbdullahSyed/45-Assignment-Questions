...
function carsInfo (manufacturer:string, model: string, ...options:[string,any][]):cartype{
    let Car:cartype ={
        manufacturer,
        model}
...
console.log(carsInfo ("Honda", "civic", ["color", "white"]))
console.log(carsInfo ("toyota", "corolla", ["Year", 2024]))